...
几周前在做项目的时候，需要实现一个功能：利用“长*宽*高”的这种形式搜索数据。需要达到的效果就是输入“number1\*number2\*number3”，其中number1、number2、number3的组合不确定，意思就是“number1\*number2\*number3”需要匹配“长\*宽\*高”、“长\*高\*款”、“宽\*长\*高”，……，等6种组合。
